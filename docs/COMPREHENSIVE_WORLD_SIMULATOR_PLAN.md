...
2. Build the first geomorphic-realism pass: convergent hillslope diffusion, drainage-conditioned valley relief, basin-aware local channel refinement, and multiscale coastal amplification that cannot change canonical land authority.

...
const historyMyr = integerOption("history-myr", 360);
...
if (format === "json") {
  ...
  process.stdout.write(`${seed}: surface sub${referenceSubdivisions} → sub${candidateSubdivisions} ${comparison.passed ? "PASS" : "FAIL"}\n`);

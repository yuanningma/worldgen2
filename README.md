...
- synchronized natural, heightmap, climate, biomes, precipitation, aridity, temperature, continentality, drainage, depression, wind, lithology, and orogeny diagnostics that all read the same canonical world instead of regenerating geography;

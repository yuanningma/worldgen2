...
- relief-conditioned world-space channel paths that add bounded lowland meanders while keeping steep mountain channels confined and all junctions tied to the resolved drainage graph;
- explicit ocean-mouth and lake-inflow records classified as deltas, estuaries, alluvial fans, simple mouths, or lake inflows, with topology-safe presentation distributaries;

...
- explicit ocean-mouth and lake-inflow records for delta, estuary, and fan development without mistaking internal lake routing for visible rivers;
- synchronized natural, heightmap, climate, biomes, precipitation, aridity, temperature, continentality, drainage, depression, geomorphology, wind, lithology, and orogeny diagnostics that all read the same canonical world instead of regenerating geography;
